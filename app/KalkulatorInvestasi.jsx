      ...
      <section id="kalkulator-investasi" className="ki">
        ...
        <div className="ki-in">
          ...
          <div className="ki-box">
            ...
            <div className="ki-why"><strong>KENAPA 2,83x?</strong> Nilai ekuitas Tahun 10 Rp2,439 T berasal dari EBITDA Tahun 10 Rp243,897 M × kelipatan valuasi dasar 10,00x. Lalu Rp2,439 T ÷ total modal proyek Rp861,088 M = 2,83x. Artinya setiap Rp1,00 modal pada model menjadi Rp2,83 nilai ekuitas Tahun 10; selisih Rp1,83 adalah kenaikan nilai model, bukan dividen tunai dan bukan hasil yang dijamin.</div>
