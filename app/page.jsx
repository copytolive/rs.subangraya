    ...
    <>
      ...
      <main>
        <section id="top" className="chapter hero-chapter">
          <div className="hero-wordmark" aria-label="RS Subang Raya">
            <span>RS</span>
            <span>SUBANG</span>
            <span>RAYA</span>
          </div>
          <div className="hero-center-copy">
            <p>IMMERSIVE HOSPITAL INVESTMENT STORY</p>
            <button className="round-cta" onClick={() => jumpTo('investment')}>↓</button>
          </div>
          <div className="hero-metrics">
            <span><b>136</b> beds</span><span><b>7</b> BIM layers</span><span><b>3</b> phases</span>
          </div>
        </section>
        ...
        <section id="investment" className="chapter split-chapter">
          ...
          <div className="chapter-copy">
            <span className="micro">INVESTMENT THESIS</span>
            <h2>LAND<br/>FIRST.</h2>
            <p>Lahan yang benar adalah keputusan investasi pertama. Legalitas, akses, utilitas, bentuk tapak dan ruang ekspansi harus terkunci sebelum modal bergerak.</p>
            <div className="pill-row"><span>ASSET-BACKED</span><span>PHASED</span><span>BIM-READY</span></div>
          </div>
          <div className="scene-window"><span>ROTATE WITH SCROLL</span></div>
        </section>

        <section id="site" className="chapter punch-chapter">
          <div className="chapter-copy dark-copy">
            <span className="micro">02 · SITE STRATEGY</span>
            <h2>3<br/>ROUTES.</h2>
            <p>Public, Emergency dan Service dibaca sebagai tiga arus terpisah pada site model.</p>
            <div className="route-pills">
              <button onClick={() => changeMode('site')}><i className="route public"/>PUBLIC</button>
              <button onClick={() => changeMode('site')}><i className="route emergency"/>EMERGENCY</button>
              <button onClick={() => changeMode('site')}><i className="route service"/>SERVICE</button>
            </div>
          </div>
        ...
        <section id="clinical" className="chapter clinical-chapter">
          ...
          <div className="clinical-top">
            <span className="micro">CLINICAL STACK</span>
            <h2>EXPLODE<br/>THE CARE.</h2>
          </div>
          <div className="clinical-scroll">
            {[
              ...
              <button key={n} onClick={() => changeMode('explode')}>
                <b>{n}</b><span><strong>{title}</strong>{body}</span>
              </button>
            ))}
          </div>
        ...
        <section id="journey" className="chapter journey-chapter">
          <div className="chapter-copy dark-copy">
            <span className="micro">04 · PATIENT JOURNEY</span>
            <h2>ONE<br/>CARE<br/>PATH.</h2>
            <button className="play-button" onClick={() => changeMode('journey')}>PLAY 3D JOURNEY ↗</button>
          </div>
          <div className="journey-strip">
            {['ARRIVE', 'REGISTER', 'DIAGNOSE', 'TREAT', 'RECOVER', 'DISCHARGE'].map((label, index) => (
              <div key={label}><b>{String(index + 1).padStart(2, '0')}</b><span>{label}</span></div>
            ))}
          </div>
        </section>
        ...
        <section id="research" className="research-chapter">
          <div className="research-intro">
            ...
            <h2>12<br/>DESIGN<br/>FRAMES.</h2>
            <p>Swipe untuk membaca perjalanan desain. Tidak ada link keluar dari presentasi.</p>
          </div>
        ...
        <section id="roadmap" className="chapter roadmap-chapter">
          ...
          <div className="chapter-copy">
            <span className="micro">DELIVERY ROADMAP</span>
            <h2>LAND<br/>TO LIVE.</h2>
          </div>
          <div className="roadmap-list">
            {[
              ['01', 'LAND + ALIGNMENT'], ['02', 'SITE FEASIBILITY'], ['03', 'CLINICAL BRIEF'], ['04', 'DED + BIM'], ['05', 'PERMITS + PROCUREMENT'], ['06', 'BUILD + COMMISSIONING'],
